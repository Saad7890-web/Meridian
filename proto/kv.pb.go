...
func (x *WatchResponse) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x03R\aversion2\xb5\x01\n" +
	"\x02KV\x12&\n" +
...
var file_proto_kv_proto_goTypes = []any{
	...
	(*WatchResponse)(nil),  // 7: kv.WatchResponse
}
var file_proto_kv_proto_depIdxs = []int32{
	...
	6, // 3: kv.KV.Watch:input_type -> kv.WatchRequest
	...
	7, // 7: kv.KV.Watch:output_type -> kv.WatchResponse
